      ...
      <div class="container" >
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="index.php?menu=tiket">Tiket Bantuan</a></li>
 ...
 -->
    ...
    <section>
      <div class='alert alert-danger'>
        ...
        By E-Couple! <a href='index.php?menu=profil' class='btn-success'>Klik Disini</a>
      </div>
    </section> 
    ";
    }
    ...
    <footer>
      <div class="container">
        <p>Copyright &copy E-COUPLE 2018</p>
      </div>
    </footer>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <section>
            <div >
              <strong>Perhatian!</strong> Lengkapi Profil Anda Untuk Mengakses Semua Fitur E-Couple! <a href='index.php?menu=profil' class='btn-success'>Klik Disini</a>
            </div>
          </section> 
        </div> 
        <div class="modal-footer">
