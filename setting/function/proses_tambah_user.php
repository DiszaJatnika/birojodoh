...
if (isset($_POST['daftar'])) {
	...
	else
	{
		...
		$query2 = mysqli_query($db, "INSERT INTO akun(username, namadepan, namabelakang, foto, jeniskelamin, status)	
											  VALUES('$username','$namadepan','$namabelakang','user.png', '$jeniskelamin', '$status')");
